...
internal static unsafe class HudAgent
{
    ...
    public static PlayerCharacter? GetPlayerCharacter(int index) => GetPlayer(GetPartyMember(index).ObjectID);
    public static PlayerCharacter? GetAllianceMember(int index) => GetPlayer(AllianceMemberObjectID[index]);
    private static PlayerCharacter? GetPlayer(uint objectId) => Service.ObjectTable.SearchById(objectId) as PlayerCharacter;
}
